...
opcode_entry opcode_table [512] = {
  ...
  /* 0x18 */	IDEXW(G2E, sbb, 1), IDEX(G2E, sbb), EMPTY, IDEX(E2G, sbb),
  /* 0x1c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x20 */	IDEXW(G2E, and, 1), IDEX(G2E, and), IDEXW(E2G, and, 1), EMPTY,
  ...
  /* 0xc8 */	EMPTY, EX(leave), EMPTY, EX(iret),
  /* 0xcc */	EMPTY, IDEX(I, int), EMPTY, EX(iret),
  /* 0xd0 */	IDEXW(gp2_1_E, gp2, 1), IDEX(gp2_1_E, gp2), IDEXW(gp2_cl2E, gp2, 1), IDEX(gp2_cl2E, gp2),
  /* 0xd4 */	EMPTY, EMPTY, EX(nemu_trap), EX(nemu_trap),
  ...
  /* 0x98 */	IDEXW(E, setcc, 1), IDEXW(E, setcc, 1), EMPTY, EMPTY,
  ...
  /* 0xbc */	EMPTY, IDEX(E2G, bsr), IDEXW(mov_E2G, movsx, 1), EMPTY,
